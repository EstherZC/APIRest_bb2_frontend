...
class ApiRestConnection extends Component
{
    ...
    static URL_REMOVE_ITEM = 'http://localhost:8080/apiRest/removeitem/';
    ...
    static URL_REMOVE_SUPPLIER ='http://localhost:8080/apiRest/removesupplier/';
    static URL_SAVE_SUPPLIER ='http://localhost:8080/apiRest/savesupplier';
